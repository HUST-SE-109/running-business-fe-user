<template>
  <div class="help-send-con">
    ...
    <el-dialog :visible.sync="userDialogVisible" :show-close=false width="50%">
      <div>
        <el-input size="mini" placeholder="请输入关键字" v-model="buyKeyword">
          <el-button class="confirm-address" slot="append" @click="handleUserMap">确认
          </el-button>
        </el-input>
        <baidu-map center="北京">
    ...
    <el-form :model="rmForm" :rules="rmRules" ref="rmForm" label-width="80px">
      ...
      <el-form-item label="发货要求" prop="remark">
        <el-col :span="11">
          <el-input type="textarea" v-model="rmForm.remark" placeholder="请输入需要发货物品的具体要求">
          </el-input>
        </el-col>
      </el-form-item>
      <el-form-item label="发货时间">
        <el-col :span="6">
          <el-select v-model="rmForm.isImmediately">
            <el-option label="立即发货" value="immediately"></el-option>
    ...
    <el-dialog :visible.sync="rmDialogVisible" :show-close=false width="50%">
      <div>
        <el-input size="mini" placeholder="请输入关键字" v-model="rmKeyword">
          <el-button class="confirm-address" slot="append" @click="handleRmMap">确认
          </el-button>
        </el-input>
        <baidu-map center="北京">
          <bm-view class="map"></bm-view>
...
export default {
  ...
  methods: {
    ...
    // offlinePayOrder() {
    //   const money =
    //     this.rmForm.payAmount + this.rmForm.fee + this.orderForm.amount;
